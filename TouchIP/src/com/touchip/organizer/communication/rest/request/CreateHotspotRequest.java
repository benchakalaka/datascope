...
public class CreateHotspotRequest extends SpringAndroidSpiceRequest <HotspotsList> {
     ...
     @Override public HotspotsList loadDataFromNetwork() throws Exception {
          return getRestTemplate().postForObject(RestAddresses.CREATE_HOTSPOT, vars, HotspotsList.class);
     }
