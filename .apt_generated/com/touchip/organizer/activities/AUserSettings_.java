...
public final class AUserSettings_
    extends AUserSettings
    implements HasViews, OnViewChangedListener
{
    ...
    public static AUserSettings_.IntentBuilder_ intent(Context context) {
        return new AUserSettings_.IntentBuilder_(context);
    }

    public static AUserSettings_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new AUserSettings_.IntentBuilder_(fragment);
    }

    public static AUserSettings_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new AUserSettings_.IntentBuilder_(supportFragment);
    }
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        AUserSettings_.this.buttonUpdateApp();
                    }
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(Context context) {
            context_ = context;
            intent_ = new Intent(context, AUserSettings_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            fragment_ = fragment;
            context_ = fragment.getActivity();
            intent_ = new Intent(context_, AUserSettings_.class);
        }
        ...
        public AUserSettings_.IntentBuilder_ flags(int flags) {
