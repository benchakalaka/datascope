...
public final class ActionBarGeneralWhiteboard_
    extends ActionBarGeneralWhiteboard
    implements HasViews, OnViewChangedListener
{
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.ab_white_board_drawing, this);
    ...
    private void init_() {
        ...
        pumpBottom = AnimationUtils.loadAnimation(getContext(), anim.pump_bottom);
