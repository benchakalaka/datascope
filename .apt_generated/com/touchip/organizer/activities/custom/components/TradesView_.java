...
public final class TradesView_
    extends TradesView
    implements HasViews, OnViewChangedListener
{
    ...
    public TradesView_(Context context) {
        super(context);
        init_();
    }

    public static TradesView build(Context context) {
        TradesView_ instance = new TradesView_(context);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.trades_view, this);
