...
public final class CPanelNoteCalendarItem_
    extends CPanelNoteCalendarItem
    implements HasViews, OnViewChangedListener
{
    ...
    public CPanelNoteCalendarItem_(Context context) {
        super(context);
        init_();
    }

    public static CPanelNoteCalendarItem build(Context context) {
        CPanelNoteCalendarItem_ instance = new CPanelNoteCalendarItem_(context);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.custom_panel_note_calendar_item, this);
