...
public final class CDialogLogout_
    extends CDialogLogout
    implements HasViews, OnViewChangedListener
{
    ...
    public CDialogLogout_(SuperActivity act, Dialog hostDialog) {
        super(act, hostDialog);
        init_();
    }

    public static CDialogLogout build(SuperActivity act, Dialog hostDialog) {
        CDialogLogout_ instance = new CDialogLogout_(act, hostDialog);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.dialog_logout, this);
        ...
        }
        {
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        CDialogLogout_.this.btnChangeUser();
                    }
