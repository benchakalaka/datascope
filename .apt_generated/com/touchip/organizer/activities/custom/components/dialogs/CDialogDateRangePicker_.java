...
public final class CDialogDateRangePicker_
    extends CDialogDateRangePicker
    implements HasViews, OnViewChangedListener
{
    ...
    public CDialogDateRangePicker_(SuperActivity act, Dialog hostDialog) {
        super(act, hostDialog);
        init_();
    }

    public static CDialogDateRangePicker build(SuperActivity act, Dialog hostDialog) {
        CDialogDateRangePicker_ instance = new CDialogDateRangePicker_(act, hostDialog);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.dialog_calendar_range_date_picker, this);
