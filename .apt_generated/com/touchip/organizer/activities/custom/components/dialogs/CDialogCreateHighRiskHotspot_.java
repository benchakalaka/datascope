...
public final class CDialogCreateHighRiskHotspot_
    extends CDialogCreateHighRiskHotspot
    implements HasViews, OnViewChangedListener
{
    ...
    public CDialogCreateHighRiskHotspot_(SuperActivity context, Map requestParams, Dialog hostDialog) {
        super(context, requestParams, hostDialog);
        init_();
    }

    public static CDialogCreateHighRiskHotspot build(SuperActivity context, Map requestParams, Dialog hostDialog) {
        CDialogCreateHighRiskHotspot_ instance = new CDialogCreateHighRiskHotspot_(context, requestParams, hostDialog);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.dialog_create_high_risk_hotspot, this);
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        CDialogCreateHighRiskHotspot_.this.ibValidFrom();
                    }
        ...
        }
        {
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        CDialogCreateHighRiskHotspot_.this.btnOk();
                    }
