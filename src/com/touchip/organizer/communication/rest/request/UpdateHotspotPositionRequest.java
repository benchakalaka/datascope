...
public class UpdateHotspotPositionRequest extends SpringAndroidSpiceRequest <ModelFullSiteInfo> {
     ...
     @Override public ModelFullSiteInfo loadDataFromNetwork() throws Exception {
          return getRestTemplate().postForObject(RestAddresses.UPDATE_HOTSPOT_POSITION, vars, ModelFullSiteInfo.class);
     }
