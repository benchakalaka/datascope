...
public class AssignUnassignHotspotRequest extends SpringAndroidSpiceRequest <CompaniesAndHotspots> {

     // Variable array for POST request
     private static Map <String, String> vars;

     public AssignUnassignHotspotRequest ( Map <String, String> variables ) {
