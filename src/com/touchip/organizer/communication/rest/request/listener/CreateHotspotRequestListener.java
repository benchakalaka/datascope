...
public class CreateHotspotRequestListener implements RequestListener <ModelHotspotsAndTrades> {
     ...
     @Override public void onRequestSuccess(ModelHotspotsAndTrades hotspots) {
          if ( null != hotspots ) {
               if ( null != hotspots.hotSpotWrapperList || (null != hotspots.unassignHotspotsWrapperList) || (null != hotspots.trades) ) {
