...
/**
 * Parent activity to any class which extends Activity in DataVision app and communicates via REST services
 * 
...
public class SpiceActivity extends FragmentActivity {
     ...
     @Override protected void onResume() {
          super.onResume();
          progressDialog = new ProgressDialog(SpiceActivity.this);
