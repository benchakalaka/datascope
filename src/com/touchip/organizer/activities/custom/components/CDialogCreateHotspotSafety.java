...
@EViewGroup ( R.layout.dialog_create_hotspot_safety ) public class CDialogCreateHotspotSafety extends RelativeLayout {
     ...
     public CDialogCreateHotspotSafety ( SpiceFragmentActivity act ) {
