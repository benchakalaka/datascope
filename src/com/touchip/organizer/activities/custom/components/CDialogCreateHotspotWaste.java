...
@EViewGroup ( R.layout.dialog_create_hotspot_safety ) public class CDialogCreateHotspotWaste extends RelativeLayout {
     ...
     public CDialogCreateHotspotWaste ( SpiceFragmentActivity act ) {
