...
import com.touchip.organizer.communication.rest.request.listener.ResponseCreateTradeHotspot;
import com.touchip.organizer.utils.GlobalConstants;
import com.touchip.organizer.utils.HTTP_PARAMS;
import com.touchip.organizer.utils.Utils;

@EViewGroup ( R.layout.dialog_create_trade ) public class CDialogCreateTradeHotspot extends RelativeLayout {
     ...
     public CDialogCreateTradeHotspot ( SuperActivity context , Map requestParams , Dialog hostDialog ) {
          super(context);
     ...
     @Click void btnOk() {
          ...
          SuperRequest <ModelHotspotsList> request = new SuperRequest <ModelHotspotsList>(activity, ModelHotspotsList.class, RestAddresses.CREATE_TRADE_HOTSPOT, requestParams);
          activity.execute(request, new ResponseCreateTradeHotspot(activity));
          dialog.dismiss();
     }
