...
import com.touchip.organizer.communication.rest.request.listener.ResponseAssignUnassignHotspot;
import com.touchip.organizer.utils.GlobalConstants;
import com.touchip.organizer.utils.HTTP_PARAMS;
import com.touchip.organizer.utils.Utils;

@EViewGroup ( R.layout.dialog_assign_unassigned_hotspot ) public class CDialogAssignUnassignedHotspot extends RelativeLayout {
     ...
     public CDialogAssignUnassignedHotspot ( SuperActivity context , Map requestParams , Dialog hostDialog ) {
          super(context);
     ...
     @Click void btnOk() {
          ...
          activity.execute(request, new ResponseAssignUnassignHotspot(activity));
          dialog.dismiss();
     }
