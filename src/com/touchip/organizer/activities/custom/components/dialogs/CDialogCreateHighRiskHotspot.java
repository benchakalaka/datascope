...
@EViewGroup ( R.layout.dialog_create_high_risk_hotspot ) public class CDialogCreateHighRiskHotspot extends RelativeLayout {
     ...
     public CDialogCreateHighRiskHotspot ( SuperActivity context , Map requestParams , Dialog hostDialog ) {
          super(context);
     ...
     @Click void btnOk() {
          // if ( !TextUtils.isEmpty(etHighRiskText.getText().toString()) )
          requestParams.put(HTTP_PARAMS.DESCRIPTION, etHighRiskText.getText().toString());
