...
import com.touchip.organizer.communication.rest.request.listener.ResponseCreateOnTheFlyHotspot;
import com.touchip.organizer.utils.GlobalConstants;
import com.touchip.organizer.utils.HTTP_PARAMS;
import com.touchip.organizer.utils.Utils;

@EViewGroup ( R.layout.dialog_create_on_the_fly_hotspot ) public class CDialogCreateOnTheFlyHotspot extends RelativeLayout {
     ...
     @ViewById static MultiSpinner multiSpinner;

     public static MultiSpinner getMultiSpinner() {
          return multiSpinner;
     }

     public static void setMultiSpinner(MultiSpinner multiSpinner) {
          CDialogCreateOnTheFlyHotspot.multiSpinner = multiSpinner;
     }
     ...
     public CDialogCreateOnTheFlyHotspot ( SuperActivity context , Map requestParams , Dialog hostDialog ) {
          super(context);
     ...
     @Click void btnOk() {
          ...
          requestParams.put(HTTP_PARAMS.DESCRIPTION, etDescription.getText().toString());
          ...
          requestParams.put(HTTP_PARAMS.TASKS, MultiSpinner.getTaskList());
          requestParams.put(HTTP_PARAMS.USER_ID, String.valueOf(GlobalConstants.CURRENT_USER.userId));

          SuperRequest <ModelCompaniesAndHotspots> request = new SuperRequest <ModelCompaniesAndHotspots>(activity, ModelCompaniesAndHotspots.class, RestAddresses.CREATE_ON_THE_FLY_TASKS, requestParams);
          activity.execute(request, new ResponseCreateOnTheFlyHotspot(activity));
