...
@SuppressLint ( "WrongCall" ) public class DraggableGridView extends ViewGroup implements View.OnTouchListener , View.OnClickListener , View.OnLongClickListener {
     ...
     public int getIndexFromCoor(int x, int y) {
          ...
          if ( index >= getChildCount() ) { return -1; }
          return index;
     }
     ...
     protected int getTargetFromCoor(int x, int y) {
          if ( getColOrRowFromCoor(y + scroll) == -1 ) { return -1;
          ...
          if ( leftPos == -1 && rightPos == -1 ) { return -1; }
          ...
          if ( dragged < target ) { return target - 1; }
