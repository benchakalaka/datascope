...
import com.touchip.organizer.communication.rest.request.listener.GetMeetingPlanRequestListener;
...
@EViewGroup ( R.layout.menu_drawing_companies_activity ) public class SlideMenuDrawingCopmanies extends ScrollView implements OnOpenListener , OnCloseListener {
     ...
     @Click void changeBrushSize() {
          ...
          buttonOk.setOnClickListener(new OnClickListener() {
               @Override public void onClick(View v) {
                    Utils.showCustomToast(activity, "Brush size is set to " + seekbar.getProgress() + " pixels", R.drawable.brush);
          ...
          seekbar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
               ...
               @Override public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                    dialog.setTitle("Set brush size (" + seekbar.getProgress() + " px)");
               }
          });
     ...
     /**
      * Display meeting plan for current date
      */
     @Click void meetingPlan() {
          meetingPlan.startAnimation(AnimationManager.load(android.R.anim.fade_out));
          GetMeetingPlanRequest request = new GetMeetingPlanRequest();
